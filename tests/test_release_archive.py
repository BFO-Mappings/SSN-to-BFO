#!/usr/bin/env python3
"""Canonical raw-USTAR release archive construction and validation regressions."""
...
import release_archive as archive  # noqa: E402
...
EXPECTED_MEMBERS = (
    "SSN2BFO-2099-01-02/",
    "SSN2BFO-2099-01-02/LICENSE",
    "SSN2BFO-2099-01-02/RELEASE-NOTES.md",
    "SSN2BFO-2099-01-02/SHA256SUMS",
    "SSN2BFO-2099-01-02/SSN2BFO.ttl",
    "SSN2BFO-2099-01-02/catalog-v001.xml",
    "SSN2BFO-2099-01-02/manifest.json",
    ...
    "SSN2BFO-2099-01-02/sources/",
    "SSN2BFO-2099-01-02/sources/SSN2BFO-COMS.xlsx",
    "SSN2BFO-2099-01-02/sources/publication-metadata.toml",
)
...
class ReleaseArchiveTests(unittest.TestCase):
    ...
    def test_member_order_duplicate_type_and_unsafe_path_mutations_are_rejected(self) -> None:
        ...
        extra_header = archive._canonical_header(f"SSN2BFO-{RELEASE_ID}/extra", is_directory=False, size=1)
...
from release_archive import canonical_archive_bytes, canonical_sidecar_bytes
...
'''
    ...
    def test_output_filename_and_sidecar_bytes_are_exact(self) -> None:
        self.assertEqual(archive.archive_filename(RELEASE_ID), "SSN2BFO-2099-01-02.tar")
        self.assertEqual(archive.sidecar_filename(RELEASE_ID), "SSN2BFO-2099-01-02.tar.sha256")
        digest = hashlib.sha256(self.value).hexdigest()
        self.assertEqual(
            archive.canonical_sidecar_bytes(RELEASE_ID, self.value),
            f"{digest}  SSN2BFO-2099-01-02.tar\n".encode("ascii"),
        )
